/**
 * Adapted flume source to just provide default JSON
 * Filtering on keywords
 */


package org.flume.source.twitter.json;
 ...
 * Only supports pulling from the sample API, and only gets new status
 * updates.
 */
