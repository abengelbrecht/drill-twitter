...
CAST(regexp_replace(t.`text`, '[^\\x00-\\x7f-\\x80-\\xad]', '_') as VARCHAR(140)) as `tweet`,
...
CAST(regexp_replace(t.retweeted_status.`text`, '[^\\x00-\\x7f-\\x80-\\xad]', '_') as VARCHAR(140)) as `retweet`,
